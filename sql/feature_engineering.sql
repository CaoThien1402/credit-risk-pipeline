-- CTE joining 4 tables + window functions.
-- WHERE l.data_source = 'historical' keeps only rows with a real outcome, excluding
-- synthetic_daily applications (loan_status is NULL/sampled for those).
